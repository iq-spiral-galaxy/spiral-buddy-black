...
//   2. SVG 문자열 생성 (near-black + silver — Spiral Buddy Black 정체성)
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${SIZE} ${SIZE}" width="${SIZE}" height="${SIZE}">
  <!-- Spiral Buddy Black: near-black 우주 + 흰/은빛 별빛 나선 -->
  <defs>
    ...
    <radialGradient id="glow" cx="58%" cy="62%" r="62%">
      ...
      <stop offset="38%" stop-color="#dfe7f2" stop-opacity="0.16"/>
      <stop offset="72%" stop-color="#aab8cf" stop-opacity="0.04"/>
      <stop offset="100%" stop-color="#aab8cf" stop-opacity="0"/>
    </radialGradient>
    <radialGradient id="coolGlow" cx="32%" cy="24%" r="62%">
      <stop offset="0%" stop-color="#cfd9ec" stop-opacity="0.1"/>
      <stop offset="58%" stop-color="#cfd9ec" stop-opacity="0.025"/>
      <stop offset="100%" stop-color="#cfd9ec" stop-opacity="0"/>
    </radialGradient>
    ...
    <linearGradient id="spiralStroke" x1="18%" y1="4%" x2="83%" y2="96%">
      ...
      <stop offset="72%" stop-color="#d6e0f0"/>
      <stop offset="100%" stop-color="#aab8cf"/>
    </linearGradient>
